                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('task.update',$task->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('name',$task->name) }}" class="form-control @error('name') is-invalid @enderror"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="start_date" value="{{ old('start_date',$task->start_date) }}" name="start_date"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="end_date" value="{{ old('end_date',$task->end_date) }}" name="end_date"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="priority" id="priority" class="form-control" required>
                                    ...
                                    <option value="0" {{ old('priority',$task->priority) == '0' ? 'selected' : '' }}>Normal</option>
                                    <option value="1" {{ old('priority',$task->priority) == '1' ? 'selected' : '' }}>High</option>
                                    <option value="2" {{ old('priority',$task->priority) == '2' ? 'selected' : '' }}>Urgent</option>
                                </select>
                            </div>
